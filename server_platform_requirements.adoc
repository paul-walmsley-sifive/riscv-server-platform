...
| `FIRM_065` | At a minimum requirement, the option ROM ISA supported by the server MUST be a RISC-V profile conforming to the requirements of the BRS-I recipe (cite:[BRS] section 2.1).
